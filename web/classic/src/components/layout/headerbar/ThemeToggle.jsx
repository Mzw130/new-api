    ...
    >
      <span className='inline-flex'>
        <Button
          ...
          theme='borderless'
          type='tertiary'
          className='!rounded-md !border border-transparent !bg-transparent !p-1.5 !text-current transition-colors hover:border-indigo-200/50 hover:!bg-indigo-500/10 focus:!bg-semi-color-fill-1 dark:hover:border-white/10 dark:hover:!bg-indigo-400/15'
        />
      </span>
    </Dropdown>
  );
