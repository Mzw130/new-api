...
*/
import { DOCS_BRAND, DOCS_CLOUD_API_BASE, DOCS_CLOUD_ORIGIN } from '@/features/docs/guides/docs-brand'
...
export function getCcSwitchGuideMarkdown(lang: string): string {
