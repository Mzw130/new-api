...
} from '@/features/docs/guides/claude-code-guide-markdown'
import {
  CC_SWITCH_GUIDE_EN,
  CC_SWITCH_GUIDE_ZH,
} from '@/features/docs/guides/cc-switch-guide-markdown'
import {
  CODEX_CLI_GUIDE_EN,
  CODEX_CLI_GUIDE_ZH,
} from '@/features/docs/guides/codex-cli-guide-markdown'
import {
  OPENCODE_GUIDE_EN,
  OPENCODE_GUIDE_ZH,
} from '@/features/docs/guides/opencode-guide-markdown'
import { CURSOR_GUIDE_EN, CURSOR_GUIDE_ZH } from '@/features/docs/guides/cursor-guide-markdown'
import {
  LOBECHAT_GUIDE_EN,
  LOBECHAT_GUIDE_ZH,
} from '@/features/docs/guides/lobechat-guide-markdown'
import {
  OPENCLAW_GUIDE_EN,
  OPENCLAW_GUIDE_ZH,
} from '@/features/docs/guides/openclaw-guide-markdown'
...
export const INTEGRATION_MARKDOWN: Record<
  IntegrationSlug,
  Record<Lang, string>
> = {
...
export const OPENAI_COMPATIBLE_MARKDOWN: Record<Lang, string> = {
  zh: OPENAPI_ZH,
  en: OPENAPI_EN,
}
...
export function getIntegrationMarkdown(
...
export function getOpenAiCompatibleMarkdown(language: string): string {
