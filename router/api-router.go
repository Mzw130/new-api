...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/pricing/official-compare", middleware.TryUserAuth(), controller.GetOfficialPricingCompare)
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.GET("/official-price-alerts", controller.GetOfficialPriceAlerts)
			modelsRoute.POST("/official-price-alerts/ack", controller.AckOfficialPriceAlerts)
