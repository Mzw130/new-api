# 1router API Electron Desktop App

This directory contains the Electron wrapper for 1router API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/1router API/data/`
  - Windows: `%APPDATA%/1router API/data/`
  - Linux: `~/.config/1router API/data/`
